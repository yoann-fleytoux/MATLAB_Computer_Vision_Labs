...
display 'Possiveis soluções de Matriz Rotação|Translação'
RT_1=[U*W*V' U(:,3)]
RT_2=[U*W*V' -U(:,3)]
RT_3=[U*W'*V' U(:,3)]
RT_4=[U*W'*V' -U(:,3)]
...
figure('name','Reconstrução 3D imagem RT_1')
...
figure('name','Reconstrução 3D imagem RT_2')
plot3(X(1:n/2),Y(1:n/2), Z(1:n/2), 'r+',X((n/2)+1:n),Y(((n/2)+1):n), Z(((n/2)+1):n), 'gx');
grid on
xlabel('X - s.c. da camara esquerda')
ylabel('Y - s.c. da camara esquerda')
...
figure('name','Reconstrução 3D imagem RT_3')
plot3(X(1:n/2),Y(1:n/2), Z(1:n/2), 'r+',X((n/2)+1:n),Y(((n/2)+1):n), Z(((n/2)+1):n), 'gx');
grid on
xlabel('X - s.c. da camara esquerda')
ylabel('Y - s.c. da camara esquerda')
...
figure('name','Reconstrução 3D imagem RT_4')
plot3(X(1:n/2),Y(1:n/2), Z(1:n/2), 'r+',X((n/2)+1:n),Y(((n/2)+1):n), Z(((n/2)+1):n), 'gx');
grid on
xlabel('X - s.c. da camara esquerda')
ylabel('Y - s.c. da camara esquerda')
